        ...
        <Fragment>
            <div className="container text-center">
                ...
                <Card className="mx-auto my-5 p-3 bg-light shadow-lg text-center rounded-lg">
                    ...
                    <hr />
                    <Card.Text>
                        El código de error HTTP 404 Not Found (404 No
                        Encontrado) de respuesta de cliente indica que el
                        servidor no puede encontrar el recurso solicitado
                    </Card.Text>
                    <hr />
                    <Card.Text>
                ...
                <Card className="mx-auto my-5 p-3 bg-light shadow-lg text-center rounded-lg">
                    ...
                    <Card.Text>
                        ...
                        completado satisfactoriamente una solicitud HTTP
                        específica. Las respuestas se agrupan en cinco clases:
                        Respuestas informativas (100–199), Respuestas
                        satisfactorias (200–299), Redirecciones (300–399),
                        Errores de los clientes (400–499), y errores de los
                        servidores (500–599).
                    </Card.Text>
                    <hr />
                    ...
                    <a href="https://www.w3schools.com/tags/ref_httpmessages.asp">
                        https://www.w3schools.com/tags/ref_httpmessages.asp (en
                        inglés)
                    </a>
                </Card>
            </div>
